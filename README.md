...
Below there is High-level view of the data collection system.
...
To combat the overfitting and to speed up the training process to converge, I modified the model so that i used the followint techniques :
##### Dropout
